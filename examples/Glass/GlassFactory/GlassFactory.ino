...
static void lv_tileview_add_datetime(lv_obj_t *parent)
{
    ...
    lv_obj_align(week_label, LV_ALIGN_TOP_MID, 0, lv_pct(55));
    ...
    lv_obj_align(month_label, LV_ALIGN_TOP_MID, 0, lv_pct(80));
...
static void lv_tileview_add_battery_voltage(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_text_font(label_voltage, &lv_font_montserrat_36, 0);
...
static void lv_gui_init()
{
    ...
    lv_obj_set_pos(tileview, 0, GlassViewable_X_Offset);
