/**
 * @file      WristbandTouchButtonEvent.ino
...
void button_event_callback(ButtonState state)
{
    ...
    case BTN_PRESSED_EVENT:
        ...
        lv_label_set_text(btn_state, "Pressed");
        break;
    case BTN_RELEASED_EVENT:
        Serial.println("Released");
        lv_label_set_text(btn_state, "Released");
        break;
    ...
    case BTN_LONG_PRESSED_EVENT:
        ...
        lv_label_set_text(btn_state, "Long \nPressed");
        break;
    case BTN_DOUBLE_CLICK_EVENT:
        Serial.println("Double click");
        lv_label_set_text(btn_state, "Double \nClick");
        break;
    case BTN_TRIPLE_CLICK_EVENT:
        Serial.println("Triple click");
        lv_label_set_text(btn_state, "Triple \nClick");
        break;
    default:
        break;
    }
...
void setup()
{
    ...
    lv_label_set_text(btn_state, "N/A");
    lv_obj_align(btn_state, LV_ALIGN_CENTER, 0, 0);
